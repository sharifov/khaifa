...
class Seo_url_redirect extends Administrator_Controller
{
    ...
    public function index(){
        ...
        $this->data['search_field'] = [
            'name' => [
                ...
                'name' => 'newurl',
                'class' => 'form-control',
                'value' => $this->input->get('newurl'),
                'placeholder' => translate('search_placeholder', true),
            ],
        ];

        // Sets Table columns
        $this->data['fields'] = ['id','newurl', 'oldurl'];
        ...
        $filter = [];
        if ($this->input->get('newurl') != null) {
            $filter['newurl LIKE "%' . $this->input->get('newurl') . '%"'] = null;
        }
    ...
    public function create(){
        ...
        $this->data['form_field']['general'] = [
            'newurl' => [
                ...
                'name' => 'newurl[]',
                'class' => 'form-control',
                'label' => translate('table_head_newurl'),
                'placeholder' => translate('table_head_newurl'),
                'value' => set_value('newurl'),
            ...
            'oldurl' => [
                ...
                'name' => 'oldurl[]',
                'class' => 'form-control',
                'label' => translate('table_head_oldurl'),
                'placeholder' => translate('table_head_oldurl'),
                'value' => set_value('newurl'),
                'validation' => ['rules' => 'required']
            ]
        ];
    ...
    public function edit($id){
        ...
        $seo = $this->{$this->model}->filter(['id' => $id])->one();
        ...
        if($seo) {
            ...
            $this->data['form_field']['general'] = [
                'newurl' => [
                    ...
                    'label' => translate('table_head_newurl'),
                    'placeholder' => translate('table_head_newurl'),
                    'value' => (set_value('newurl')) ? set_value('newurl') : $seo->newurl,
                    'validation' => ['rules' => 'required']
                ],
                'oldurl' => [
                    'property' => 'text',
                    ...
                    'label' => translate('table_head_oldurl'),
                    'placeholder' => translate('table_head_oldurl'),
                    'value' => (set_value('oldurl')) ? set_value('oldurl') : $seo->oldurl,
                    'validation' => ['rules' => 'required']
                ]
            ];
            ...
            $this->template->render($this->controller . '/edit');
        } else {
            show_404();
        }
    }
    ...
    public function delete($id = null){
        if($id != null && (int)$id){
            if($_SERVER['REQUEST_METHOD'] == 'GET'){
                $this->db->where('id', $id);
                $this->db->delete('wc_seo_url_redirect');
