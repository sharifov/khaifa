...
class Auth
{
    ...
    public function __construct()
    {
        ...
        $this->CI->lang->load('authentication_lang');
    }
    ...
    public function remind_password($email)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $this->CI->email->message($this->CI->lang->line('authentication_email_reset_text') . site_url() . $this->config_vars['reset_seller_link'] . $ver_code);
            $this->CI->email->send();
