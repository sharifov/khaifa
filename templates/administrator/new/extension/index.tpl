...
<div class="panel panel-white">
	...
	<div class="table-toolbar-area" style="display: none; border-bottom: 1px solid #dfdfdf; background: #f5f5f5; padding: 10px;">
		<div class="row">
			...
			<div class="col-md-11" style="padding-top: 5px">
				...
				<label class="checkbox-inline"><input type="checkbox" name="fields[]" class="styled table-column-checkbox" checked="checked" value="{$column}">{$column_data.table.{$current_lang}}</label></a>
				{/foreach}
			</div>
			<div class="col-md-1">				
	...
	{/if}
	{form_open_multipart(site_url_multi($admin_url)|cat:'/extension/delete', 'class="form-horizontal" id="form-list"')}
	{$table}
	{form_close()}
