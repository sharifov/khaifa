{extends file=$layout}
{block name=content}
<link rel="stylesheet" href="{$admin_theme}/assets/css/datetimepicker.css?v=1">
<link rel="stylesheet" href="{$admin_theme}/global_assets/css/icons/fontawesome/styles.min.css">
<script src="{$admin_theme}/assets/js/datetimepicker.js"></script>
<style> 
	td{
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td>
									<span class="is-editable">{$order->created_at}</span>
									<input type="text" name="created_at" class="datetimepicker elem-control" autocomplete="off" value="{$order->created_at}"/>
								</td>
							</tr>
							<tr>
						...
						<tbody>
							<tr>
								<td>
									...
									<span class="is-editable">{$address->firstname}</span>
									<input type="text" name="firstname" class="elem-control" autocomplete="off" value="{$address->firstname}"/>
								</td>
							</tr>
							<tr>
								<td>
									<strong>Lastname:</strong>
									<span class="is-editable">{$address->lastname}</span>
									<input type="text" name="lastname" class="elem-control" autocomplete="off" value="{$address->lastname}"/>
								</td>
							</tr>
							<tr>
								<td>
									<strong>Company:</strong>
									<span class="is-editable">{$address->company}</span>
									<input type="text" name="company" class="elem-control" autocomplete="off" value="{$address->company}"/>
								</td>
							</tr>
							<tr>
								<td>
									<strong>Address 1:</strong>
									<span class="is-editable">{$address->address_1}</span>
									<input type="text" name="address_1" class="elem-control" autocomplete="off" value="{$address->address_1}"/>
								</td>
							</tr>
							<tr>
								<td>
									<strong>Address 2:</strong>
									<span class="is-editable">{$address->address_2}</span>
									<input type="text" name="address_2" class="elem-control" autocomplete="off" value="{$address->address_2}"/>
								</td>
							</tr>
							<tr>
								<td>
									<strong>City:</strong>
									<span class="is-editable">{$address->city}</span>
									<input type="text" name="city" class="elem-control" autocomplete="off" value="{$address->city}"/>
								</td>
							</tr>
							<tr>
								<td>
									<strong>Postcode:</strong>
									<span class="is-editable">{$address->postcode}</span>
									<input type="text" name="postcode" class="elem-control" autocomplete="off" value="{$address->postcode}"/>
								</td>
							</tr>
							<tr>
								<td>
									<strong>Country:</strong>
									<span class="is-editable">{get_country_name($address->country_id)}</span>
									<select name="country_id" class="elem-control">
										{foreach get_country_all() as $country}
											<option {if $country->id == $address->country_id } selected="selected" {/if} value="{$country->id}">{$country->name}</option>
										{/foreach}
									</select>
								</td>
							</tr>
							<tr>
								<td>
									...
									<span class="is-editable">{get_region_name($address->zone_id)}</span>
									<select name="zone_id" class="elem-control">
										{foreach get_region_all() as $zone}
											<option {if $zone->id == $address->zone_id } selected="selected" {/if} value="{$zone->id}">{$zone->name}</option>
										{/foreach}
									</select>
								</td>
							</tr>
							<tr>
								<td>
									<strong>Phone:</strong>
									<span class="is-editable">{$address->phone}</span>
									<input type="text" name="phone" class="elem-control" autocomplete="off" value="{$address->phone}"/>
								</td>
							</tr>
...
{*							<td class="text-left">{translate('model')}</td>*}
					...
					{foreach $shipping_methods as $shipping_method}
						{if isset($shipping_method['products_array'])}
							{assign var=counter value=0}
							{foreach from=$shipping_method['products_array'] item=product}
								...
								<tr>
									...
									<td class="text-left">
										...
										<br/><br/>
										<div>
											<span class="is-editable">Product Serial Number {if $product->product_seria} - {$product->product_seria} {/if}</span>
											<input type="text" data-id="{$product->id}" placeholder="Product Serial Number" class="elem-control" value="{$product->product_seria}" name="product_seria"/>
										</div>
									</td>
									<td class="text-left">
									...
									{if $counter == 1}
										<td class="text-right" rowspan="{count($shipping_method['products_array'])}">{$shipping_method['name']} ({intval($shipping_method['price'])} USD)</td>
									{/if}
                                    {assign var=shipping value=json_decode($product->shipping)}
